...
def get_custom_dataset(split, args):
    ...
    with tf.device("/cpu:0"):
        print('staring  11111111111111')
        print(args.train_glob)
        sources = os.listdir(args.train_glob)
        files = []
        for src in sources:
            files.append(args.train_glob + src)
...
def parse_args(argv):
    ...
    train_cmd.add_argument(
        "--steps_per_epoch", type=int, default=33,
...
if __name__ == "__main__":
    ...
    # python bls2017.py -V train --train_glob /home/dingchaofan/data/cc_compression/source/ --lambda 0.1
    # Assets written to: bls2017/assets

    # python bls2017.py --model_path bls2017 compress ../dataset/Clipboard\ -\ 2021-05-21\ 21.38.34.png johnson111.tfci
    # python bls2017.py --model_path bls2017 decompress johnson111.tfci reconstruction11.png
